...
public class SDKAccessHelperBAMM {
   ...
   public JsonNode getJsonSchema( String urn) {
      AspectModelJsonSchemaGenerator jsonSchemaGenerator =
            new AspectModelJsonSchemaGenerator();
   ...
   public Try<byte[]> getHtmlDocu( String urn ) {
      ...
      ByteArrayOutputStream output = new ByteArrayOutputStream();
      AspectModelDocumentationGenerator documentationGenerator =
            new AspectModelDocumentationGenerator( context );

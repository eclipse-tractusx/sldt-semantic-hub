...
public class BAMMSdk {
   ...
   public void validate( final Model model, final Function<String, Model> tripleStoreRequester ) {
      final io.openmanufacturing.sds.aspectmodel.resolver.ResolutionStrategy resolutionStrategy =
            new BAMMSdk.TripleStoreResolutionStrategy( tripleStoreRequester );

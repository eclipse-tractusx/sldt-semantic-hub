  ...
  public void testAasxEndpointExpectSuccess() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.get("/api/v1/models/{urn}/aas?aasFormat=XML", toMovementUrn(urnPrefix)).with(jwtTokenFactory.allRoles()))
      ...
      .andExpect(content().xml("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
            + "<aas:environment xmlns:aas=\"https://admin-shell.io/aas/3/0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"https://admin-shell.io/aas/3/0 AAS.xsd\"><aas:assetAdministrationShells><aas:assetAdministrationShell><idShort>id_defaultAdminShell</idShort><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>defaultAdminShell</aas:text></aas:langStringTextType></aas:description><administration/><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>Movement</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>Movement</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Aspect for movement information</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications><assetInformation><assetKind>Type</assetKind></assetInformation></aas:assetAdministrationShell></aas:assetAdministrationShells><aas:submodels><aas:submodel><idShort>Movement</idShort><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>Aspect for movement information</aas:text></aas:langStringTextType></aas:description><administration/><id>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement]/submodel</id><kind>Template</kind><aas:semanticId><aas:type>ModelReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement</aas:value></aas:key></aas:keys></aas:semanticId><aas:submodelElements><aas:property><idShort>id_moving</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Moving</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>Flag indicating if the position is changing</aas:text></aas:langStringTextType></aas:description><aas:semanticId><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#moving</aas:value></aas:key></aas:keys></aas:semanticId><valueType>xs:boolean</valueType><value>Unknown</value></aas:property><aas:property><idShort>id_speedLimitWarning</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Speed Limit Warning</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>Indicats if speed limit is adhered to.</aas:text></aas:langStringTextType></aas:description><aas:semanticId><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#speedLimitWarning</aas:value></aas:key></aas:keys></aas:semanticId><valueType>xs:string</valueType><value>Unknown</value></aas:property><aas:submodelElementCollection><idShort>id_SpatialPosition</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Spatial Position</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>Position in space, described along three axis, with the third axis optional, if all positions are in a plane.</aas:text></aas:langStringTextType></aas:description><aas:value><aas:property><idShort>id_x</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>x</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>x coordinate in space</aas:text></aas:langStringTextType></aas:description><aas:semanticId><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#x</aas:value></aas:key></aas:keys></aas:semanticId><valueType>xs:float</valueType><value>Unknown</value></aas:property><aas:property><idShort>id_y</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>y</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>y coordinate in space</aas:text></aas:langStringTextType></aas:description><aas:semanticId><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#y</aas:value></aas:key></aas:keys></aas:semanticId><valueType>xs:float</valueType><value>Unknown</value></aas:property><aas:property><idShort>id_z</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>z</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>z coordinate in space</aas:text></aas:langStringTextType></aas:description><aas:semanticId><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>ConceptDescription</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#z</aas:value></aas:key></aas:keys></aas:semanticId><valueType>xs:float</valueType><value>Unknown</value></aas:property></aas:value></aas:submodelElementCollection></aas:submodelElements></aas:submodel></aas:submodels><aas:conceptDescriptions><aas:conceptDescription><category>APPLICATION_CLASS</category><idShort>id_Movement</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Movement</aas:text></aas:langStringNameType></aas:displayName><aas:description><aas:langStringTextType><aas:language>en</aas:language><aas:text>Aspect for movement information</aas:text></aas:langStringTextType></aas:description><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#Movement]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>Movement</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>Movement</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Aspect for movement information</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_Boolean</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Boolean</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#moving</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#moving]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>Moving</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>moving</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:dataType>BOOLEAN</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents a boolean value (i.e. a \"flag\").</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_WarningLevel</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Warning Level</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#speedLimitWarning</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#speedLimitWarning]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>Speed Limit Warning</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>speedLimitWarning</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:dataType>STRING</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents if speed of position change is within specification (green), within tolerance (yellow), or outside specification (red).</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition><aas:valueList><aas:valueReferencePairs><aas:valueReferencePair><aas:value>DefaultScalarValue[value=green, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value><aas:valueId><aas:type>ModelReference</aas:type><aas:keys><aas:key><aas:type>DataElement</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#WarningLevel:DefaultScalarValue[value=green, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value></aas:key></aas:keys></aas:valueId></aas:valueReferencePair><aas:valueReferencePair><aas:value>DefaultScalarValue[value=yellow, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value><aas:valueId><aas:type>ModelReference</aas:type><aas:keys><aas:key><aas:type>DataElement</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#WarningLevel:DefaultScalarValue[value=yellow, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value></aas:key></aas:keys></aas:valueId></aas:valueReferencePair><aas:valueReferencePair><aas:value>DefaultScalarValue[value=red, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value><aas:valueId><aas:type>ModelReference</aas:type><aas:keys><aas:key><aas:type>DataElement</aas:type><aas:value>urn:samm:org.eclipse.tractusx.testaas:1.0.0#WarningLevel:DefaultScalarValue[value=red, typeUri='DefaultScalar[metaModelVersion=SAMM_2_1_0, urn='http://www.w3.org/2001/XMLSchema#string']']</aas:value></aas:key></aas:keys></aas:valueId></aas:valueReferencePair></aas:valueReferencePairs></aas:valueList></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_Coordinate</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Coordinate</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#x</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#x]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>x</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>x</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:unit>metre</aas:unit><aas:dataType>REAL_MEASURE</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents a coordinate along an axis in space.</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_Coordinate</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Coordinate</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#y</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#y]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>y</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>y</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:unit>metre</aas:unit><aas:dataType>REAL_MEASURE</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents a coordinate along an axis in space.</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_Coordinate</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Coordinate</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#z</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#z]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>z</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>z</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:unit>metre</aas:unit><aas:dataType>REAL_MEASURE</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents a coordinate along an axis in space.</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription><aas:conceptDescription><idShort>id_PositionSingleEntity</idShort><aas:displayName><aas:langStringNameType><aas:language>en</aas:language><aas:text>Spatial Position Characteristic</aas:text></aas:langStringNameType></aas:displayName><id>urn:samm:org.eclipse.tractusx.testaas:1.0.0#position</id><aas:embeddedDataSpecifications><aas:embeddedDataSpecification><aas:dataSpecification><aas:type>ExternalReference</aas:type><aas:keys><aas:key><aas:type>GlobalReference</aas:type><aas:value>Optional[urn:samm:org.eclipse.tractusx.testaas:1.0.0#position]</aas:value></aas:key></aas:keys></aas:dataSpecification><aas:dataSpecificationContent><aas:dataSpecificationIec61360><aas:preferredName><aas:langStringPreferredNameTypeIec61360><aas:language>en</aas:language><aas:text>Position</aas:text></aas:langStringPreferredNameTypeIec61360></aas:preferredName><aas:shortName><aas:langStringShortNameTypeIec61360><aas:language>EN</aas:language><aas:text>position</aas:text></aas:langStringShortNameTypeIec61360></aas:shortName><aas:dataType>STRING</aas:dataType><aas:definition><aas:langStringDefinitionTypeIec61360><aas:language>en</aas:language><aas:text>Represents a single location in space.</aas:text></aas:langStringDefinitionTypeIec61360></aas:definition></aas:dataSpecificationIec61360></aas:dataSpecificationContent></aas:embeddedDataSpecification></aas:embeddedDataSpecifications></aas:conceptDescription></aas:conceptDescriptions></aas:environment>\n"));
